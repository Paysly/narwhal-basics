...
public class AppWhitelist extends Whitelist {
    public AppWhitelist() {
        //copied from Whitelist.basicWithImages()
    ...
    protected boolean isSafeAttribute(String tagName, Element el, Attribute attr) {
        return ("img".equals(tagName)
                ...
                && (attr.getValue().startsWith("data:image/jpeg;base64") ||
                attr.getValue().startsWith("data:image/jpg;base64")) ||
                attr.getValue().startsWith("data:image/png;base64"))
                ||
