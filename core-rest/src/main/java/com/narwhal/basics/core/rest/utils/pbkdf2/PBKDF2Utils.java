package com.narwhal.basics.core.rest.utils.pbkdf2;


import com.narwhal.basics.core.rest.utils.pbkdf2.exception.PBKDF2EncodingException;
...
public class PBKDF2Utils {
    ...
    public static String createHash(String password) {
        try {
            ...
            throw new PBKDF2EncodingException("Password cannot be encrypt", e);
