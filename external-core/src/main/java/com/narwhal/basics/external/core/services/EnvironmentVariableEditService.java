...
@Singleton
public class EnvironmentVariableEditService extends BaseEditService<Serializable, EnvironmentVariable, EnvironmentVariableDTO> {
    ...
    @Override
    protected EnvironmentVariable initFromDTO(Serializable config, EnvironmentVariableDTO dto) {
