...
public interface MemcachedConstants {
    ...
    String NOTIFICATION_LANGUAGE_GROUPS_KEYS = "NOTIFICATION_%s_LANGUAGE_GROUPS";
    String NOTIFICATION_LANGUAGE_ITEMS_KEYS = "NOTIFICATION_%s_%s_LANGUAGE_ITEMS";
    String NOTIFICATION_LANGUAGE_TEMPLATES_KEYS = "NOTIFICATION_%s_%s_%s_LANGUAGE_TEMPLATES";
